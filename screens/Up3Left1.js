...
class Up3Left1 extends Component{
constructor(props){
super(props)
...
else if(this.props.x<16){this.props.GoUp3Left2()}
...
else if(this.props.x>304){this.props.GoUp3()}
...
return{GoUp3Left2:()=>dispatch({type:'Go_Up3Left2'}),GoUp3:()=>dispatch({type:'Go_Up3'}),
kleft:()=>dispatch({type:'kleft'}),kright:()=>dispatch({type:'kright'}),kup:()=>dispatch({type:'kup'}),kdown:()=>dispatch({type:'kdown'})}}

export default connect(mapStateToProps,mapDispatchToProps)(Up3Left1)