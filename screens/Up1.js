...
if(this.props.y>304){this.props.GoFriendScreen()
...
if(this.props.y<16){this.props.GoUp2()
...
if(this.props.x<16){this.props.GoUp1Left1()
this.props.navigation.navigate('Up1Left1')}}
...
if(this.props.x>304){this.props.GoUp1Right1()
...
return{GoFriendScreen:()=>dispatch({type:'Go_FriendScreen'}),GoUp1Left1:()=>dispatch({type:'Go_Up1Left1'}),GoUp1Right1:()=>dispatch({type:'Go_Up1Right1'}),GoUp2:()=>dispatch({type:'Go_Up2'}),
kleft:()=>dispatch({type:'kleft'}),kright:()=>dispatch({type:'kright'}),kup:()=>dispatch({type:'kup'}),kdown:()=>dispatch({type:'kdown'})}}

export default connect(mapStateToProps,mapDispatchToProps)(Up1)