...
class Up3Right1 extends Component{
constructor(props){
super(props)
...
else if(this.props.x<16){this.props.GoUp3()}
...
else if(this.props.x>304){this.props.GoUp3Right2()}
...
return{GoUp3Right2:()=>dispatch({type:'Go_Up3Right2'}),GoUp3:()=>dispatch({type:'Go_Up3'}),
kleft:()=>dispatch({type:'kleft'}),kright:()=>dispatch({type:'kright'}),kup:()=>dispatch({type:'kup'}),kdown:()=>dispatch({type:'kdown'})}}

export default connect(mapStateToProps,mapDispatchToProps)(Up3Right1)