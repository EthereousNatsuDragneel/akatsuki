...
class Up1Left2 extends Component{
constructor(props){
super(props)
...
return{GoUp1Left1:()=>dispatch({type:'Go_Up1Left1'}),
kleft:()=>dispatch({type:'kleft'}),kright:()=>dispatch({type:'kright'}),kup:()=>dispatch({type:'kup'}),kdown:()=>dispatch({type:'kdown'})}}

export default connect(mapStateToProps,mapDispatchToProps)(Up1Left2)