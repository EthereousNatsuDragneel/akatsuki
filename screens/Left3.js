...
else if(this.props.x<16){this.props.GoLeft4()}
...
else if(this.props.x>304){this.props.GoLeft2()}
...
return{GoLeft2:()=>dispatch({type:'Go_Left2'}),GoLeft4:()=>dispatch({type:'Go_Left4'}),
kleft:()=>dispatch({type:'kleft'}),kright:()=>dispatch({type:'kright'}),kup:()=>dispatch({type:'kup'}),kdown:()=>dispatch({type:'kdown'})}}

export default connect(mapStateToProps,mapDispatchToProps)(Left3)