...
class Up1Right1 extends Component{
constructor(props){
super(props)
...
else if(this.props.x<16){this.props.GoUp1()}
...
else if(this.props.x>304){this.props.GoUp1Right2()}
...
return{GoUp1Right2:()=>dispatch({type:'Go_Up1Right2'}),GoUp1:()=>dispatch({type:'Go_Up1'}),
kleft:()=>dispatch({type:'kleft'}),kright:()=>dispatch({type:'kright'}),kup:()=>dispatch({type:'kup'}),kdown:()=>dispatch({type:'kdown'})}}

export default connect(mapStateToProps,mapDispatchToProps)(Up1Right1)