...
class Up2Left1 extends Component{
constructor(props){
super(props)
...
else if(this.props.x<16){this.props.GoUp2Left2()}
...
else if(this.props.x>304){this.props.GoUp2()}
...
return{GoUp2Left2:()=>dispatch({type:'Go_Up2Left2'}),GoUp2:()=>dispatch({type:'Go_Up2'}),
kleft:()=>dispatch({type:'kleft'}),kright:()=>dispatch({type:'kright'}),kup:()=>dispatch({type:'kup'}),kdown:()=>dispatch({type:'kdown'})}}

export default connect(mapStateToProps,mapDispatchToProps)(Up2Left1)